...
const AppplyBookSchema = mongoose.Schema({
...
AppplyBookSchema.statics = {
	...
	load: function (id, callback) {
		this.findOne({ _id: id }).populate('writer', 'name email').exec(callback);
	},
...
const ApplyBookModel = mongoose.model('ApplyBookModel', ApplyBookSchema);
module.exports = ApplyBookModel;